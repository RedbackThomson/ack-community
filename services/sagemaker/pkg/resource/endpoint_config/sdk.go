...
func (rm *resourceManager) sdkFind(
	...
	resp, respErr := rm.sdkapi.DescribeEndpointConfigWithContext(ctx, input)
	if respErr != nil {
...
func (rm *resourceManager) newListRequestPayload(
	r *resource,
) (*svcsdk.ListEndpointConfigsInput, error) {
	res := &svcsdk.ListEndpointConfigsInput{}
...
func (rm *resourceManager) sdkCreate(
	...
	resp, respErr := rm.sdkapi.CreateEndpointConfigWithContext(ctx, input)
	if respErr != nil {
		return nil, respErr
	}
	// Merge in the information we read from the API call above to the copy of
...
func (rm *resourceManager) sdkDelete(
	...
	_, respErr := rm.sdkapi.DeleteEndpointConfigWithContext(ctx, input)
	return respErr
}
