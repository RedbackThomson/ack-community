...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=coderepositories,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=coderepositories/status,verbs=get;update;patch
