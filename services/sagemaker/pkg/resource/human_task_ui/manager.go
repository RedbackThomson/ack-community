...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=humantaskuis,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=humantaskuis/status,verbs=get;update;patch
