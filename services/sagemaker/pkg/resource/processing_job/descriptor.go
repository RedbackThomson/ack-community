...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/ProcessingJob"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.ProcessingJob{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.ProcessingJob),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.ProcessingJob{}))
	return &diffReporter
}
