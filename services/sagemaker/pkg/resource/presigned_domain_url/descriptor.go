...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/PresignedDomainURL"
)

var (
	resourceGK = metav1.GroupKind{
		Group: "sagemaker.services.k8s.aws",
		Kind:  "PresignedDomainURL",
	}
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.PresignedDomainURL{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.PresignedDomainURL),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.PresignedDomainURL{}))
	return &diffReporter
}
