...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=presigneddomainurls,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=presigneddomainurls/status,verbs=get;update;patch
