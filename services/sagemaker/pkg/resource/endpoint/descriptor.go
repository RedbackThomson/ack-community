...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/Endpoint"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.Endpoint{}))
	return &diffReporter
}
