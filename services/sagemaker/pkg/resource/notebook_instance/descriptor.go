...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/NotebookInstance"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.NotebookInstance{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.NotebookInstance),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.NotebookInstance{}))
	return &diffReporter
}
