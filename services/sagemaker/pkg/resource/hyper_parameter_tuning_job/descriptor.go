...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/HyperParameterTuningJob"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.HyperParameterTuningJob{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.HyperParameterTuningJob),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.HyperParameterTuningJob{}))
	return &diffReporter
}
