...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=automljobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=automljobs/status,verbs=get;update;patch
