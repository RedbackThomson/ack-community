...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/AutoMLJob"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.AutoMLJob{}))
	return &diffReporter
}
