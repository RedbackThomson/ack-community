...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=trials,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=trials/status,verbs=get;update;patch
