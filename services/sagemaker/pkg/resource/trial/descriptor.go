...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/Trial"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.Trial{}))
	return &diffReporter
}
