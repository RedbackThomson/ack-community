...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/NotebookInstanceLifecycleConfig"
)
...
func (d *resourceDescriptor) EmptyRuntimeObject() k8sapirt.Object {
	return &svcapitypes.NotebookInstanceLifecycleConfig{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.NotebookInstanceLifecycleConfig),
	}
}
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.NotebookInstanceLifecycleConfig{}))
	return &diffReporter
}
