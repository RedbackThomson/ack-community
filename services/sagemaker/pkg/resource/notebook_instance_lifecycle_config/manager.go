...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=notebookinstancelifecycleconfigs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=notebookinstancelifecycleconfigs/status,verbs=get;update;patch
