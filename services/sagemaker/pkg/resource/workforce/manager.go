...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=workforces,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=workforces/status,verbs=get;update;patch
