...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=workteams,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=workteams/status,verbs=get;update;patch
