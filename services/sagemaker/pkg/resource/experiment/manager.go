...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=experiments,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=experiments/status,verbs=get;update;patch
