...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/Experiment"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.Experiment{}))
	return &diffReporter
}
