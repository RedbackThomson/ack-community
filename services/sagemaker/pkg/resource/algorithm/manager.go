...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=algorithms,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=algorithms/status,verbs=get;update;patch
