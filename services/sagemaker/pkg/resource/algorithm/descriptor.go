...
const (
	finalizerString = "finalizers.sagemaker.services.k8s.aws/Algorithm"
)
...
func (d *resourceDescriptor) Diff(
	...
	cmp.Equal(ac.ko, bc.ko, cmp.Reporter(&diffReporter), cmp.AllowUnexported(svcapitypes.Algorithm{}))
	return &diffReporter
}
