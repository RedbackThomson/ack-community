...
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=compilationjobs,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=sagemaker.services.k8s.aws,resources=compilationjobs/status,verbs=get;update;patch
